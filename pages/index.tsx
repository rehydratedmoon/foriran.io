    ...
    <div className="space-y-32">
      ...
      <section className="">
        <img
          ...
          alt=""
          className="w-full max-w-full max-w-min(100%,30rem) mx-auto px-10 dark:filter-invert"
        />
        ...
        <p className=" c-gray11 max-w-60ch  text-center mx-auto">
          ...
          داده‌ها و محتوای مهم انقلاب ایران را گردآوری، دسترسی‌پذیر و قابل جستجو می‌کند تا در میان موج‌های شبکه‌های
          اجتماعی فراموش نشوند.
        </p>
      </section>
      <section>
        <ul className="grid grid-min-col-10rem gap-10 list-none">
          <li className="">
            <img src="/images/accessible.svg" alt="" className="-mb-4   w-5/7 dark:filter-invert" />
          ...
          <li className="">
            <img src="/images/focus.svg" alt="" className="-mb-4  w-5/7 dark:filter-invert" />
          ...
          <li className="">
            <img src="/images/search.svg" alt="" className="-mb-4   w-5/7 dark:filter-invert" />
